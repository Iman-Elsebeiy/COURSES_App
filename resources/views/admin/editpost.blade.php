        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        <br />
                        {{-- الفورم مربوط بالـ route posts.store --}}
                        <form action="{{ route('admin.posts.update', $post->id) }}" method="POST" enctype="multipart/form-data" class="form-horizontal form-label-left">
                            @csrf
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 ">
                                    <input type="text" id="title" name="title" value="{{ $post->title }}" required="required" class="form-control">
                                </div>
                            </div>
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 ">
                                    <textarea id="content" name="content" required="required" class="form-control">{{ $post->content }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 ">
                                      @if($post->image)
            <img src="{{ asset('storage/'.$post->image) }}" width="100" alt="Post Image"><br>
        @endif
                                </div>
                            </div>
                            ...
                            <div class="item form-group">
                                <div class="col-md-6 col-sm-6 offset-md-3">
                                    <a href="{{ route('admin.posts') }}" class="btn btn-primary">Cancel</a>
