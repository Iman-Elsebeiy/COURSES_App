            ...
            <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        ...
                        {{-- الفورم مربوط بالـ route admin.courses.update --}}
                        <form action="{{ route('admin.courses.update', $course->id) }}"
                            ...
                            {{-- Course Image --}}
                            <div class="item form-group">
                                <label class="col-form-label col-md-3 col-sm-3 label-align" for="course_image">
                                    Course Image
                                </label>
                                <div class="col-md-6 col-sm-6">
                                    @if($course->course_image)
                                        <img src="{{ asset('storage/'.$course->course_image) }}"
                                             width="100" alt="Course Image"><br><br>
                                    @endif
                            ...
                            {{-- Teacher Image --}}
                            <div class="item form-group">
                                <label class="col-form-label col-md-3 col-sm-3 label-align" for="teacher_image">
                                    Teacher Image
                                </label>
                                <div class="col-md-6 col-sm-6">
                                    @if($course->teacher_image)
                                        <img src="{{ asset('storage/'.$course->teacher_image) }}"
                                             width="100" alt="Teacher Image"><br><br>
                                    @endif
                            ...
                            {{-- Teacher Job --}}
                            <div class="item form-group">
                                <label class="col-form-label col-md-3 col-sm-3 label-align" for="teacher_job">
                                    Teacher Job
                                </label>
                                <div class="col-md-6 col-sm-6">
                                    <input type="text" id="teacher_job" name="teacher_job"
                                           value="{{ old('teacher_job', $course->teacher_job) }}"
                                           class="form-control">
                                </div>
                            </div>
                            ...
                            {{-- Lessons --}}
                            <div class="item form-group">
                                <label class="col-form-label col-md-3 col-sm-3 label-align" for="lessons">
                                    Lessons
                                </label>
                                <div class="col-md-6 col-sm-6">
                                    <input type="number" id="lessons" name="lessons"
                            ...
                            {{-- Teacher --}}
                            <div class="item form-group">
                                <label class="col-form-label col-md-3 col-sm-3 label-align" for="teacher_id">
