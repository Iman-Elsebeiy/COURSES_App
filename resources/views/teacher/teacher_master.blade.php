      ...
      <div  class="main_container">
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style=" border: 0;">
              <a href="index.html" class="site_title"><i class="fa fa-laptop"></i> <span>Teacher admin</span></a>
            </div>
            ...
            <div class="nav_menu">
                ...
                <ul class=" navbar-right">
                  <li class="nav-item dropdown open" style="padding-left: 15px;">
                    <a href="{{asset('admin/javascript:;')}}" class="user-profile dropdown-toggle" aria-haspopup="true" id="navbarDropdown" data-toggle="dropdown" aria-expanded="false">
                    ...
                    <a class="dropdown-item"  href="{{asset('admin/javascript:;')}}">Help</a>
                      <a class="dropdown-item"  href="login.html"><i class="fa fa-sign-out pull-right"></i> Log Out</a>
                    </div>
                  </li>
  
                  <li role="presentation" class="nav-item dropdown open">
                    <a href="{{asset('admin/javascript:;')}}" class="dropdown-toggle info-number" id="navbarDropdown1" data-toggle="dropdown" aria-expanded="false">
        ...
        {{-- <footer>
          <div class="pull-right">
            Gentelella - Bootstrap Admin Template by <a href="{{asset('admin/https://colorlib.com')}}">Colorlib</a>
          </div>
          <div class="clearfix"></div>
        </footer> --}}
        <!-- /footer content -->
